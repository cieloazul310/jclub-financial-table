...
/**
 * source:
 * https://github.com/digital-go-jp/design-system-example-components-react/blob/main/src/components/HamburgerMenuButton/parts/HamburgerWithLabelIcon.tsx
 */
...
export const HamburgerWithLabelIcon = (props: HamburgerWithLabelIconProps) => {
  const { className, isEnglish = false, ...rest } = props;
  return (
    <>
      {isEnglish ? (
        <svg
