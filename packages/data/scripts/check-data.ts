...
export function checkData(input: any) {
  ...
  // const BaseDatumSchema = RequiredSchema.extend(OptionalSchema.shape);
  ...
  return {
    ...data,
    unit_price: createUnitPrice({ ticket, all_attd }),
    average_attd: Math.round(league_attd / league_games),
  } as FinancialDatum;
}
